...
class Finger extends Phalange
{
	constructor(parentJoint, leftOrRight, number)
	{
		...
		this.minRot = new THREE.Vector3( Math.min(minX,maxX), this.y, thumb?-90:-10);
		this.maxRot = new THREE.Vector3( Math.max(minX,maxX), this.y, thumb?45:120);
...
//			grad(this.rotation.y),
	...
	set posture(pos)
	{
		...
		this.rotation.z = rad(pos[1]);
		this.mid.rotation.set(rad(pos[2]), 0, rad(pos[3]), 'XYZ');
		this.tip.rotation.set(rad(pos[4]), 0, rad(pos[5]), 'XYZ');
	}
} // Finger
...
class Fingers extends Joint
{
	...
	constructor( parentJoint, finger_0, finger_1, finger_2, finger_3, finger_4 )
	{
		super(parentJoint, null, {}, null);
...
class Nails extends Joint
{
	...
	recolor(color, secondaryColor = color)
	{
		this.nail_0.recolor( color, secondaryColor );
		this.nail_1.recolor( color, secondaryColor );
		this.nail_2.recolor( color, secondaryColor );
		this.nail_3.recolor( color, secondaryColor );
		this.nail_4.recolor( color, secondaryColor );
	}
...
class Mannequin extends THREE.Group
{
	constructor(feminine, height = 1)
	{
		...
		this.l_fingers = new Fingers( this.l_wrist, this.l_finger_0, this.l_finger_1, this.l_finger_2, this.l_finger_3, this.l_finger_4 );
		...
		this.r_fingers = new Fingers( this.r_wrist, this.r_finger_0, this.r_finger_1, this.r_finger_2, this.r_finger_3, this.r_finger_4 );
		this.r_nails = new Fingers( this.r_finger_0, this.r_finger_1, this.r_finger_2, this.r_finger_3, this.r_finger_4 );
